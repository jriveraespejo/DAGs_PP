...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				%
				\item special case of masked relationships
				\item an instance of \textcolor{blue}{fork bias}
				%
			\end{itemize}
		...
		\begin{column}{0.5\textwidth}  
			...
			\begin{figure}
				...
				\begin{tikzpicture}
					...
					\draw [{Circle}-{latex}](-1,0)--(0.9,0); % LL->H
					\draw [{Circle [open]}-{latex}{Circle}](1.7,0)--(0.9,0); % Uh->H
					\draw [{Circle [color=red]}-{latex}](0,0.8)--(0.9,0.1); % RL->H
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.5]{fork5_reg2.png}}]
	{the dream team!!}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.7]{fork6_reg4.png}}]
	{did it worked???}
