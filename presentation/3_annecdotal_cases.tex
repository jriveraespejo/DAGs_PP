...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			%
			\begin{figure}
				\includegraphics[scale=0.8]{fork4_code.png}
				\caption*{(c) R code}
			\end{figure}
			%
			\textcolor{blue}{Implications},
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.3]{fork4_reg.png}}]
	{Regression, regression!!}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.45]{fork4_samplesize.pdf}}]
	{I'll get more data!!}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.5]{fork4_reg2.png}}]
	{the dream team!!}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				%
				\item extreme case of masked relationships
				\item an instance of \textcolor{blue}{fork bias}
				%
			\end{itemize}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			%
			\begin{figure}
				\includegraphics[scale=0.7]{fork5_code.png}
				\caption*{(c) R code}
			\end{figure}
			%
			\textcolor{blue}{Implications},
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.39]{fork5_samplesize.pdf}}]
	...
	\begin{itemize}
		%
		\item the more \textcolor{blue}{incorrect} you are about your estimates
		\item the less \textcolor{blue}{certain} you are about your estimates
		\item the more \textcolor{blue}{mistaken} you are about your research question
		%
	\end{itemize}
	%
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				{\small (but it is unobservable)}
				%
				\item we still use the 2nd D-separation rule by controlling for $RL$, \\
				i.e. \ndsep{LL}{H} \; | RL \\
				%
				\item but $RL$ and $LL$ give the same information, i.e. singular matrix, \\
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.6]{fork5_reg1.png}}]
	{Not so great now??}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Fork bias: bias amplification}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
\begin{frame}[t, negative]
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			%
			\begin{figure}
				\includegraphics[scale=0.8]{fork6_code.png}
				\caption*{(c) R code}
			\end{figure}
			%
			\textcolor{blue}{Implications},
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.4]{fork6_panel.pdf}}]
	{``Eyeballing" analysis}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.3]{fork6_reg.png}}]
	{Regression, regression!!}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.45]{fork6_samplesize.pdf}}]
	{I'll get more data!!}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.7]{fork6_reg3.png}}]
	{did it worked???}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.30]{fork6_reg4.png}}]
	{did it worked???}
	...
	%
	\begin{figure}
		\includegraphics[scale=0.7]{fork6_code2.png}
	\end{figure}
	%
\end{lhframe}
%
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.5]{pipe1_reg2.png}}]
	{the dream team!!}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				%
				\item included variable bias (bigger grouping)
				%
			\end{itemize}
		...
		\begin{column}{0.5\textwidth}  
			...
			\begin{figure}
				...
				\begin{tikzpicture}
					...
					\draw [{Circle [open]}-{latex}](0.9,1.3)--(0.1,0.8); % Uf->F
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.4]{pipe2_panel.pdf}}]
	{``Eyeballing" analysis}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.5]{pipe2_reg2.png}}]
	{the dream team!!}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			%
			\begin{figure}
				\includegraphics[scale=0.8]{pipe7_code.png}
				\caption*{(c) R code}
			\end{figure}
			%
			\textcolor{blue}{Implications},
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.4]{pipe7_panel.pdf}}]
	{``Eyeballing" analysis}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.3]{pipe7_reg.png}}]
	{Regression, regression!!}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.45]{pipe7_samplesize.pdf}}]
	{I'll get more data!!}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.5]{pipe7_reg2.png}}]
	{the dream team!!}
