...
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.45]{fork1_samplesize.pdf}}]
	...
	\begin{itemize}
		...
		\item the more \textcolor{blue}{biased} are your estimates \\
...
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.39]{fork5_samplesize.pdf}}]
	...
	\begin{itemize}
		%
		\item the less \textcolor{blue}{certain} are your estimates
		\item the more \textcolor{blue}{biased} are your estimates
		%
	\end{itemize}
	%
...
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.45]{fork3_samplesize.pdf}}]
	...
	\begin{itemize}
		%
		\item you are \textcolor{blue}{more certain} about your estimates
		\item no issue with \textcolor{blue}{biasing} estimates \\
		{\small (under the any model)}
		%
	\end{itemize}
	%
...
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.45]{pipe2_stat.png}}]
	...
	\begin{itemize}
		...
		%
		\item \textcolor{blue}{diluted relationship} when both are in the model \\
...
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.45]{pipe2_samplesize.pdf}}]
	...
	\begin{itemize}
		%
		\item the more \textcolor{blue}{certain} you are about your estimates
		\item the more \textcolor{blue}{biased} is the estimate of treatment, but not of fungus
		%
	\end{itemize}
	%
\end{lhframe}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				i.e. \ndsep{T}{$H_1$} \; | F \\
				%
				\item therefore if we want to find if $T=1$ works, we should not control for $F$
				%
			\end{itemize}
			%
		\end{column}
