...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{XXX bias: sensitivity analysis}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{XXX bias: post-stratification}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
\begin{frame}[t, negative, label=sa]
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				%
				\item How \textcolor{blue}{random effects} work (in a way)
				%
			\end{itemize}
...
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.4]{descendant1_panel.pdf}}]
	...
	\begin{itemize}
		...
		{\small (older teachers has older type of instruction, and lower score)}
		%
		\item but $cor(X, M)<0$ does not go in line \\
...
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.45]{descendant1_samplesize.pdf}}]
	...
	\begin{itemize}
		%
		\item under the \textcolor{blue}{incorrect model}, \\
		the more \textcolor{blue}{certain} you are about your \textcolor{blue}{biased} estimates
		%
		\item under the \textcolor{blue}{corrected model}, \\
...
%
\begin{frame}
	{But age is a cause of experience, right?}
	%
	\begin{columns}
		%
		\begin{column}{0.5\textwidth}
